"""
Data Transfer Object for updating a workspace/organization.
"""
...
class UpdateWorkspacePayload(BaseModel):
    """Payload for updating a Trello workspace/organization."""

    display_name: Optional[str] = Field(
        None, min_length=1, max_length=16384, description="Workspace display name"
    )
