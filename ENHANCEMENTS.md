# Trello MCP Server Enhancements

## Overview

This document describes the enhancements made to the Trello MCP Server, including new features, improved validation, and enhanced error handling.
...
Full workspace/organization management capabilities:

**List Workspaces** - View all workspaces you're a member of

**Get Workspace** - Retrieve detailed workspace information

**Get Workspace Boards** - List all boards in a workspace with filtering options
...
**`server/services/workspace.py`** - Workspace/organization service layer

**`server/tools/workspace.py`** - Workspace MCP tools
...
await validator.validate_organization_membership(org_id)
```
...
- Bulk operations (create multiple boards)
